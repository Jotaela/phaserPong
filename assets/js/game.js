...
var mainState = {
    preload: function() {
        ...
        game.load.image('ball', 'assets/cara.png');
    },
    ...
    update: function() {
        ...
        // I fixed the game restart when hitting the ground by incrementing the y position of the ball in 10px. because of the ball image what made the ball hitbox bigger
        if (this.ball.y + 10 > this.paddle.y)
